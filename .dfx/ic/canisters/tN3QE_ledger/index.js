...
import { idlFactory } from './tN3QE_ledger.did.js';
export { idlFactory } from './tN3QE_ledger.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TN3QE_LEDGER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./tN3QE_ledger.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the tN3QE_ledger canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./tN3QE_ledger.did.js")._SERVICE>}
 */
export const tN3QE_ledger = createActor(canisterId);
