...
import { idlFactory } from './tN3QE_index.did.js';
export { idlFactory } from './tN3QE_index.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TN3QE_INDEX;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./tN3QE_index.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the tN3QE_index canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./tN3QE_index.did.js")._SERVICE>}
 */
export const tN3QE_index = createActor(canisterId);
